...
- (BoxAPIJSONOperation *)deleteFolderWithID:(NSString *)folderID requestBuilder:(BoxFoldersRequestBuilder *)builder success:(BoxSuccessfulDeleteBlock)successBlock failure:(BoxAPIJSONFailureBlock)failureBlock timeoutInterval:(NSTimeInterval)timeout;
{
    NSURL *URL = [self URLWithResource:BOX_API_FOLDERS_RESOURCE
                                    ID:folderID
                           subresource:nil
    ...
    operation.APIRequest.timeoutInterval = timeout;
    [self.queueManager enqueueOperation:operation];
