...
- (BoxAPIDataOperation *)downloadURLForFileWithID:(NSString *)fileID requestBuilder:(BoxFilesRequestBuilder *)builder success:(BoxDownloadURLSuccessBlock)successBlock failure:(BoxDownloadFailureBlock)failureBlock{
    ...
    operation.fileID = fileID;
    operation.operationURLSuccessBlock = successBlock;
    operation.failureBlock = failureBlock;
    [self.queueManager enqueueOperation:operation];
