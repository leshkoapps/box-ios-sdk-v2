...
typedef void (^BoxDownloadURLSuccessBlock)(NSString *fileID, NSURL *url);
...
@property (nonatomic, readwrite, strong) BoxDownloadURLSuccessBlock operationURLSuccessBlock;
